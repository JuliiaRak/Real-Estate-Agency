...
CREATE TABLE IF NOT EXISTS real_estates (
    ...
    FOREIGN KEY(seller_id) REFERENCES clients(id) ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS real_estate_has_tags (
    ...
    FOREIGN KEY(real_estate_id) REFERENCES real_estates(id) ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS meetings (
    ...
    FOREIGN KEY(real_estate_id) REFERENCES real_estates(id) ON UPDATE NO ACTION ON DELETE CASCADE,
    FOREIGN KEY(buyer_id) REFERENCES clients(id) ON UPDATE NO ACTION ON DELETE CASCADE,
